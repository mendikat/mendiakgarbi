<div class="row">
    ...
    <div class="col-lg-13 col-lg-offset-7">
        ...
        <form>
            ...
            <div class="row">
                <input type="text" placeholder="{{$event_your_name}}">
            </div>

            <div class="row">
                <input type="email" placeholder="{{$event_your_email}}" spellcheck="false">
            </div>
            ...
            <div>
                <textarea style="margin-top: 10px;" rows="5" placeholder="{{$event_description}}" spellcheck="true"></textarea>
            </div>
